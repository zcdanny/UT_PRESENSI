...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Pemagang</h5>
                            ...
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" maxlength="5" value="" id="nik"
                                        class="form-control" placeholder="ID MBKM" name="nik">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" id="jabatan" value="" class="form-control"
                                        name="jabatan" placeholder="Mentor">
                                </div>
                            </div>
                        </div>
                        <div class="row">
    ...
    <div class="modal modal-blur fade" id="modal-editkaryawan" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Data Pemagang</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
